...
class AboutData {
    ...
    var marshall = community(organization: "Marshall Medical Center", positions: [position(name: "Volunteer", startDate: "April 2016", endDate: "March 2020", jobs: ["Worked alongside the volunteer coordinator and kept track of various data for all volunteers within Marshall Medical Center.", "Aided the Marketing department in various tasks such as sending newsletters and setting up fundraisers."])])
