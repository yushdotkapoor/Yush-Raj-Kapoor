...
class AboutData {
    ...
    var biking = hobby(name: "Mountain Biking", years: "4 years", description: "Here is a short description")
    var music = hobby(name: "Music", years: "11 years", description: "Here is another short description")
