...
class SkillsData {
    ...
    var appsscript = skill(name: "Google Apps   Script", subunits: ["Spreadsheet connections", "Firebase", "HTML connections", "Scripts on timers"], experience: "2 years of experience")
    ...
    init() {
        skills = [xcode, swift, beard, firebase, appsscript, java, python, html, aws]
    }
